...
_CFG = load_venue_config("venue_shacklewell_arms")
_URL = _CFG["url"]
...
_SKIP_RE = re.compile(r"\bkaraoke\b|\bquiz\b|\bbingo\b|\bcomedy\b|\bstandup\b|\bstand.up\b", re.IGNORECASE)
...
class ShacklewellArmsSource(BaseSource):
    source_id = "venue_shacklewell_arms"
    live = False
